...
const about_title = usePage().props.about_title;
const about_short_description = usePage().props.about_short_description;
const about_full_description = usePage().props.about_full_description;

const form = useForm({
    about_title: about_title,
    about_short_description: about_short_description,
    about_full_description: about_full_description,
});
    ...
    <form class="form mb-5" @submit.prevent="submit">
        ...
        <!-- <div class="form-items">
            <div class="form-item text-input" style="grid-column: 1 / -1;">
                <ResourseTextInput label="Заголовок" :error="form.errors.about_title" />
            </div>
            <div class="form-item text-input" style="grid-column: 1 / -1;">
