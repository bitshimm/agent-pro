...
<template>
    <form class="form mb-5" @submit.prevent="submit">
        ...
        <div class="form-items">
            ...
            <FormEl default-col="2">
                <WysiwigTextarea label="Полное описание" id="about_full_description" :error="form.errors.about_full_description" :form="form" v-model="form.about_full_description" />
            </FormEl>
        </div>
