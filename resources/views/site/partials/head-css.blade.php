<link rel="stylesheet" href="{{ $url }}/css/fontawesome/css/brands.min.css">
<link rel="stylesheet" href="{{ $url }}/css/fontawesome/css/regular.min.css">
<link rel="stylesheet" href="{{ $url }}/css/fontawesome/css/solid.min.css">
<link rel="stylesheet" href="{{ $url }}/css/fontawesome/css/fontawesome.min.css">
